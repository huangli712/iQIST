...
ch09 = Any[
            ...
            "Algorithms" => Any[
                "README" => "ch09/algo.md",
                "Transition probability" => "ch09/tran.md",
                "Hubbard-Holstein model" => "ch09/holstein.md",
                "Dynamical screening effect" => "ch09/screening.md",
                "Physical observable" => "ch09/obs.md",
                "Orthogonal polynomial representation" => "ch09/ortho.md",
                "Kernel polynomial method" => "ch09/kpm.md",
                "Improved estimator for the self-energy function" => "ch09/sig.md",
                "Fast matrix update" => "ch09/fast.md",
                "Good quantum number, subspace, and symmetry" => "ch09/symmetry.md",
                "Krylov subspace iteration" => "ch09/krylov.md",
                "Newton-Leja polynomial interpolation" => "ch09/leja.md",
                "Truncation approximation" => "ch09/truncation.md",
                "Lazy trace evaluation" => "ch09/lazy.md",
                "Skip listing algorithm" => "ch09/skip.md",
                "Divide-and-conquer algorithm" => "ch09/dac.md",
                "Sparse matrix tricks" => "ch09/sparse.md",
                "Delayed update algorithm" => "ch09/delay.md",
                "Atomic eigenvalue solver" => "ch09/atomic.md",
                "Single particle basis" => "ch09/basis.md",
                "Spin-orbit coupling" => "ch09/soc.md",
                "Coulomb interaction matrix" => "ch09/coulomb.md",
                "Maximum entropy method" => "ch09/mem.md",
                "Stochastic analytical continuation" => "ch09/sac.md",
            ],
            "Codes" => Any[
                "README" => "ch09/code.md",
