...
!! [body
     ...
     write(mystd,'(4X,a16,i10,  2X,a8)') 'isopt  / value :', isopt , 'type : i'
     write(mystd,'(4X,a16,i10,  2X,a8)') 'iscut  / value :', iscut , 'type : i'
...
!! [body
     ...
     write(mystd,'(4X,2a)') 'fast trace evaluation    / ', opt(isopt)
     write(mystd,'(4X,2a)') 'dynamic truncation       / ', cut(iscut)
