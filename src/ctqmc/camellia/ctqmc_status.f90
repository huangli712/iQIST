...
! current date, in CCYYMMDD format
     character(8 ) :: str_date

! current time, in hhmmss.sss format
     character(10) :: str_time
...
! write the header message
     call date_and_time( date = str_date, time = str_time )
     ...
     write(mytmp,'(a)') '>> generated by PANSY code at '//str_date//'-'//str_time
