...
!! type 'make begonia' command in the terminal. On the contrary, if you
!! want to compile begonia as a library, please use 'make begonia-lib'.
!! If you want to obtain a python module, please use 'make begonia-pylib'.
!!
!! Introduction
!! ============
!!
