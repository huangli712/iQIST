...
!! type 'make lavender' command in the terminal. On the contrary, if you
!! want to compile lavender as a library, please use 'make lavender-lib'.
!! If you want to obtain a python module, please use 'make lavender-pylib'.
!!
!! Introduction
!! ============
!!
...
!! it is somewhat less efficient than the begonia code. It can be used as
