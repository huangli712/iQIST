...
# if defined (MPI)
     ...
     write(mystd,'(2X,a,i4)') 'NARCISSUS >>> parallelism: Yes >>> processors:', nprocs

# else   /* MPI */

     write(mystd,'(2X,a,i4)') 'NARCISSUS >>> parallelism: No  >>> processors:', 1
...
! obtain current date and time
     ...
     write(mystd,'(2X,a)') 'NARCISSUS >>> I am tired and want to go to bed. Bye!'
     write(mystd,'(2X,a)') 'NARCISSUS >>> happy ending at '//date_time_string
...
! about iteration number
     write(mystd,'(2X,a,i3,2(a,i10))') 'NARCISSUS >>> iter:', iter, ' sweep:', cstep, ' of ', nsweep
