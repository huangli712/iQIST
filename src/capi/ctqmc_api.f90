...
!!
!! 2. compile api and common
!! -------------------------
!!
!! Please compile api and common at first. You can type the 'make api'
...
!! it (together with src/api/capi.mod and src/common/libMM.a) to your own
...
!! occupation number), and nnmat (i.e., double occupation number) directly
