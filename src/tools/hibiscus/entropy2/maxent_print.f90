...
!!>>> maxent_print_header: print header information of this program
...
! obtain current date and time
     ...
     write(mystd,'(2X,a)') 'version: 2014.10.14T '//'(built at '//__TIME__//" "//__DATE__//')'
...
!!>>> maxent_print_footer: print goodbye information
...
!!>>> maxent_print_summary: print control parameters
...
!!>>> maxent_print_advice: print advice when diagonalize kmat and amat error
