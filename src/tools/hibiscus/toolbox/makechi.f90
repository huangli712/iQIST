...
!! function. It can output the magnetic susceptibility and effective
!! magnetic moment. So far only the gardenia and narcissus codes can build
!! the spin-spin correlation function in imaginary time space.
!!
!! Usage
!! =====
!!
