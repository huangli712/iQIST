...
!! [body
     ...
     gaunt1( -2 ,  0 ,  2 ) = -2*sqrt(5.0_dp) / 15 * ( 1.0 )
     ...
     gaunt1( -1 ,  1 ,  2 ) = 2*sqrt(6.0_dp) / 15 * ( -1.0 )
     gaunt1(  0 , -2 ,  2 ) = -2*sqrt(5.0_dp) / 15 * ( 1.0 )
     ...
     gaunt1( -2 , -1 ,  4 ) = 4*sqrt(2.0_dp)/33 * ( 1.0 )
     ...
     gaunt1( -1 , -2 ,  4 ) = 4*sqrt(2.0_dp)/33 * ( -1.0 )
     gaunt1( -1 , -1 ,  4 ) = -sqrt(1.0_dp) /33 * ( -1.0 )
     gaunt1( -1 ,  0 ,  4 ) = -sqrt(15.0_dp)/33 * ( -1.0 )
     gaunt1( -1 ,  1 ,  4 ) = 2*sqrt(10.0_dp)/33 * ( -1.0 )
     ...
     gaunt1(  2 ,  0 ,  4 ) = -sqrt(3.0_dp)/33 * ( 1.0 )
     gaunt1(  2 ,  1 ,  4 ) = 4*sqrt(2.0_dp)/33 * ( 1.0 )
     gaunt1(  2 ,  2 ,  4 ) = -7.0_dp/33 * ( 1.0 )
     gaunt1(  2 ,  3 ,  4 ) = sqrt(30.0_dp)/33 * ( 1.0 )
     gaunt1(  3 , -1 ,  4 ) = -sqrt(42.0_dp)/33 * ( -1.0 )
     gaunt1(  3 ,  0 ,  4 ) = sqrt(7.0_dp)/11 * ( -1.0 )
     gaunt1(  3 ,  1 ,  4 ) = -sqrt(6.0_dp)/11 * ( -1.0 )
     gaunt1(  3 ,  2 ,  4 ) = sqrt(30.0_dp)/33 * ( -1.0 )
     gaunt1(  3 ,  3 ,  4 ) = -1.0_dp/11 * ( -1.0 )

     gaunt1( -3 , -3 ,  6 ) = 5.0_dp/429 * ( -1.0 )
     ...
     gaunt1( -1 , -1 ,  6 ) = 25.0_dp/143 * ( -1.0 )
     gaunt1( -1 ,  0 ,  6 ) = -25*sqrt(14.0_dp)/429 * ( -1.0 )
     gaunt1( -1 ,  1 ,  6 ) = 10*sqrt(105.0_dp)/429 * ( -1.0 )
