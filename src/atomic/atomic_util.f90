...
!! [body
     ...
     select case (nband)
         ...
         !
         case (7)
             tmat_c2j(  1,  1 ) = -sqrt(six/7.0_dp)
             tmat_c2j(  1,  8 ) = sqrt(one/7.0_dp)
             tmat_c2j(  2,  2 ) = -sqrt(five/7.0_dp)
             tmat_c2j(  2,  9 ) = sqrt(two/7.0_dp)
             tmat_c2j(  3,  3 ) = -sqrt(four/7.0_dp)
             tmat_c2j(  3, 10 ) = sqrt(three/7.0_dp)
             tmat_c2j(  4,  4 ) = -sqrt(three/7.0_dp)
             tmat_c2j(  4, 11 ) = sqrt(four/7.0_dp)
             tmat_c2j(  5,  5 ) = -sqrt(two/7.0_dp)
             tmat_c2j(  5, 12 ) = sqrt(five/7.0_dp)
             tmat_c2j(  6,  6 ) = -sqrt(one/7.0_dp)
             tmat_c2j(  6, 13 ) = sqrt(six/7.0_dp)
             tmat_c2j(  7, 14 ) = one
             tmat_c2j(  8,  7 ) = one
             tmat_c2j(  9,  1 ) = sqrt(one/7.0_dp)
             tmat_c2j(  9,  8 ) = sqrt(six/7.0_dp)
             tmat_c2j( 10,  2 ) = sqrt(two/7.0_dp)
             tmat_c2j( 10,  9 ) = sqrt(five/7.0_dp)
             tmat_c2j( 11,  3 ) = sqrt(three/7.0_dp)
             tmat_c2j( 11, 10 ) = sqrt(four/7.0_dp)
             tmat_c2j( 12,  4 ) = sqrt(four/7.0_dp)
             tmat_c2j( 12, 11 ) = sqrt(three/7.0_dp)
             tmat_c2j( 13,  5 ) = sqrt(five/7.0_dp)
             tmat_c2j( 13, 12 ) = sqrt(two/7.0_dp)
             tmat_c2j( 14,  6 ) = sqrt(six/7.0_dp)
