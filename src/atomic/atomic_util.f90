...
!! [body
     ...
     gaunt1( -3 , -3 ,  2 ) =  sqrt( 1.0_dp) /  3.0_dp * ( -1.0 )
     gaunt1( -3 , -2 ,  2 ) = -sqrt( 1.0_dp) /  3.0_dp * ( -1.0 )
     gaunt1( -3 , -1 ,  2 ) =  sqrt(10.0_dp) / 15.0_dp * ( -1.0 )
     gaunt1( -2 , -3 ,  2 ) = -sqrt( 1.0_dp) /  3.0_dp * (  1.0 )
     gaunt1( -2 , -1 ,  2 ) =  sqrt(15.0_dp) / 15.0_dp * (  1.0 )
     gaunt1( -2 ,  0 ,  2 ) = -sqrt(20.0_dp) / 15.0_dp * (  1.0 )
     gaunt1( -1 , -3 ,  2 ) =  sqrt(10.0_dp) / 15.0_dp * ( -1.0 )
     gaunt1( -1 , -2 ,  2 ) =  sqrt(15.0_dp) / 15.0_dp * ( -1.0 )
     gaunt1( -1 , -1 ,  2 ) = -sqrt( 1.0_dp) /  5.0_dp * ( -1.0 )
     gaunt1( -1 ,  0 ,  2 ) = -sqrt( 2.0_dp) / 15.0_dp * ( -1.0 )
     gaunt1( -1 ,  1 ,  2 ) =  sqrt(24.0_dp) / 15.0_dp * ( -1.0 )
     gaunt1(  0 , -2 ,  2 ) = -sqrt(20.0_dp) / 15.0_dp * (  1.0 )
     gaunt1(  0 , -1 ,  2 ) = -sqrt( 2.0_dp) / 15.0_dp * (  1.0 )
     gaunt1(  0 ,  0 ,  2 ) =  sqrt(16.0_dp) / 15.0_dp * (  1.0 )
     gaunt1(  0 ,  1 ,  2 ) = -sqrt( 2.0_dp) / 15.0_dp * (  1.0 )
     gaunt1(  0 ,  2 ,  2 ) = -sqrt(20.0_dp) / 15.0_dp * (  1.0 )
     gaunt1(  1 , -1 ,  2 ) =  sqrt(24.0_dp) / 15.0_dp * ( -1.0 )
     gaunt1(  1 ,  0 ,  2 ) = -sqrt( 2.0_dp) / 15.0_dp * ( -1.0 )
     ...
     gaunt1( -3 , -3 ,  4 ) = -sqrt( 1.0_dp) / 11.0_dp * ( -1.0 )
     gaunt1( -3 , -2 ,  4 ) =  sqrt(30.0_dp) / 33.0_dp * ( -1.0 )
     gaunt1( -3 , -1 ,  4 ) = -sqrt( 6.0_dp) / 11.0_dp * ( -1.0 )
     gaunt1( -3 ,  0 ,  4 ) =  sqrt( 7.0_dp) / 11.0_dp * ( -1.0 )
     gaunt1( -3 ,  1 ,  4 ) = -sqrt(42.0_dp) / 33.0_dp * ( -1.0 )
     gaunt1( -2 , -3 ,  4 ) =  sqrt(30.0_dp) / 33.0_dp * (  1.0 )
     gaunt1( -2 , -2 ,  4 ) = -sqrt(49.0_dp) / 33.0_dp * (  1.0 )
     gaunt1( -2 , -1 ,  4 ) =  sqrt(32.0_dp) / 33.0_dp * (  1.0 )
     gaunt1( -2 ,  0 ,  4 ) = -sqrt( 3.0_dp) / 33.0_dp * (  1.0 )
     gaunt1( -2 ,  1 ,  4 ) = -sqrt(14.0_dp) / 33.0_dp * (  1.0 )
     gaunt1( -2 ,  2 ,  4 ) =  sqrt(70.0_dp) / 33.0_dp * (  1.0 )
     gaunt1( -1 , -3 ,  4 ) = -sqrt( 6.0_dp) / 11.0_dp * ( -1.0 )
     gaunt1( -1 , -2 ,  4 ) =  sqrt(32.0_dp) / 33.0_dp * ( -1.0 )
     gaunt1( -1 , -1 ,  4 ) = -sqrt( 1.0_dp) / 33.0_dp * ( -1.0 )
     gaunt1( -1 ,  0 ,  4 ) = -sqrt(15.0_dp) / 33.0_dp * ( -1.0 )
     gaunt1( -1 ,  1 ,  4 ) =  sqrt(40.0_dp) / 33.0_dp * ( -1.0 )
     gaunt1( -1 ,  2 ,  4 ) = -sqrt(14.0_dp) / 33.0_dp * ( -1.0 )
     gaunt1( -1 ,  3 ,  4 ) = -sqrt(42.0_dp) / 33.0_dp * ( -1.0 )
     gaunt1(  0 , -3 ,  4 ) =  sqrt( 7.0_dp) / 11.0_dp * (  1.0 )
     gaunt1(  0 , -2 ,  4 ) = -sqrt( 3.0_dp) / 33.0_dp * (  1.0 )
     gaunt1(  0 , -1 ,  4 ) = -sqrt(15.0_dp) / 33.0_dp * (  1.0 )
     gaunt1(  0 ,  0 ,  4 ) =  sqrt( 4.0_dp) / 11.0_dp * (  1.0 )
     gaunt1(  0 ,  1 ,  4 ) = -sqrt(15.0_dp) / 33.0_dp * (  1.0 )
     gaunt1(  0 ,  2 ,  4 ) = -sqrt( 3.0_dp) / 33.0_dp * (  1.0 )
     gaunt1(  0 ,  3 ,  4 ) =  sqrt( 7.0_dp) / 11.0_dp * (  1.0 )
     gaunt1(  1 , -3 ,  4 ) = -sqrt(42.0_dp) / 33.0_dp * ( -1.0 )
     ...
     gaunt1( -3 , -3 ,  6 ) =  sqrt(   25.0_dp) / 429.0_dp * ( -1.0 )
     gaunt1( -3 , -2 ,  6 ) = -sqrt(  175.0_dp) / 429.0_dp * ( -1.0 )
     gaunt1( -3 , -1 ,  6 ) =  sqrt(  700.0_dp) / 429.0_dp * ( -1.0 )
     gaunt1( -3 ,  0 ,  6 ) = -sqrt( 2100.0_dp) / 429.0_dp * ( -1.0 )
     gaunt1( -3 ,  1 ,  6 ) =  sqrt( 5250.0_dp) / 429.0_dp * ( -1.0 )
     gaunt1( -3 ,  2 ,  6 ) = -sqrt(11550.0_dp) / 429.0_dp * ( -1.0 )
     gaunt1( -3 ,  3 ,  6 ) =  sqrt(23100.0_dp) / 429.0_dp * ( -1.0 )
     gaunt1( -2 , -3 ,  6 ) = -sqrt(  175.0_dp) / 429.0_dp * (  1.0 )
     gaunt1( -2 , -2 ,  6 ) =  sqrt(  100.0_dp) / 143.0_dp * (  1.0 )
     gaunt1( -2 , -1 ,  6 ) = -sqrt( 2625.0_dp) / 429.0_dp * (  1.0 )
     gaunt1( -2 ,  0 ,  6 ) =  sqrt( 5600.0_dp) / 429.0_dp * (  1.0 )
     gaunt1( -2 ,  1 ,  6 ) = -sqrt( 1050.0_dp) / 143.0_dp * (  1.0 )
     gaunt1( -2 ,  2 ,  6 ) =  sqrt( 1400.0_dp) / 143.0_dp * (  1.0 )
     gaunt1( -2 ,  3 ,  6 ) = -sqrt(11550.0_dp) / 429.0_dp * (  1.0 )
     gaunt1( -1 , -3 ,  6 ) =  sqrt(  700.0_dp) / 429.0_dp * ( -1.0 )
     gaunt1( -1 , -2 ,  6 ) = -sqrt( 2625.0_dp) / 429.0_dp * ( -1.0 )
     gaunt1( -1 , -1 ,  6 ) =  sqrt(  625.0_dp) / 143.0_dp * ( -1.0 )
     gaunt1( -1 ,  0 ,  6 ) = -sqrt( 8750.0_dp) / 429.0_dp * ( -1.0 )
     gaunt1( -1 ,  1 ,  6 ) =  sqrt(10500.0_dp) / 429.0_dp * ( -1.0 )
     gaunt1( -1 ,  2 ,  6 ) = -sqrt( 1050.0_dp) / 143.0_dp * ( -1.0 )
     gaunt1( -1 ,  3 ,  6 ) =  sqrt( 5250.0_dp) / 429.0_dp * ( -1.0 )
     gaunt1(  0 , -3 ,  6 ) = -sqrt( 2100.0_dp) / 429.0_dp * (  1.0 )
     gaunt1(  0 , -2 ,  6 ) =  sqrt( 5600.0_dp) / 429.0_dp * (  1.0 )
     gaunt1(  0 , -1 ,  6 ) = -sqrt( 8750.0_dp) / 429.0_dp * (  1.0 )
     gaunt1(  0 ,  0 ,  6 ) =  sqrt(10000.0_dp) / 429.0_dp * (  1.0 )
     gaunt1(  0 ,  1 ,  6 ) = -sqrt( 8750.0_dp) / 429.0_dp * (  1.0 )
     gaunt1(  0 ,  2 ,  6 ) =  sqrt( 5600.0_dp) / 429.0_dp * (  1.0 )
     gaunt1(  0 ,  3 ,  6 ) = -sqrt( 2100.0_dp) / 429.0_dp * (  1.0 )
     gaunt1(  1 , -3 ,  6 ) =  sqrt( 5250.0_dp) / 429.0_dp * ( -1.0 )
