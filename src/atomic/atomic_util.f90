...
!! [body
     ...
     gaunt1( -3 ,  1 ,  6 ) = sqrt(5250.0_dp)/429 * ( -1.0 )
     gaunt1( -3 ,  2 ,  6 ) = -sqrt(11550.0_dp)/429 * ( -1.0 )
     gaunt1( -3 ,  3 ,  6 ) = sqrt(23100.0_dp)/429 * ( -1.0 )
     gaunt1( -2 , -3 ,  6 ) = -sqrt(175.0_dp)/429 * ( 1.0 )
     gaunt1( -2 , -2 ,  6 ) = sqrt(100.0_dp)/143 * ( 1.0 )
     gaunt1( -2 , -1 ,  6 ) = -sqrt(2625.0_dp)/429 * ( 1.0 )
     gaunt1( -2 ,  0 ,  6 ) = 20*sqrt(14.0_dp)/429 * ( 1.0 )
     gaunt1( -2 ,  1 ,  6 ) = -5*sqrt(42.0_dp)/143 * ( 1.0 )
     gaunt1( -2 ,  2 ,  6 ) = sqrt(1400.0_dp)/143 * ( 1.0 )
     gaunt1( -2 ,  3 ,  6 ) = -sqrt(11550.0_dp)/429 * ( 1.0 )
     gaunt1( -1 , -3 ,  6 ) = sqrt(700.0_dp)/429 * ( -1.0 )
     gaunt1( -1 , -2 ,  6 ) = -sqrt(2625.0_dp)/429 * ( -1.0 )
     ...
     gaunt1( -1 ,  3 ,  6 ) = sqrt(5250.0_dp)/429 * ( -1.0 )
     ...
     gaunt1(  2 , -3 ,  6 ) = -sqrt(11550.0_dp)/429 * ( 1.0 )
     gaunt1(  2 , -2 ,  6 ) = sqrt(1400.0_dp)/143 * ( 1.0 )
     gaunt1(  2 , -1 ,  6 ) = -sqrt(1050.0_dp)/143 * ( 1.0 )
     gaunt1(  2 ,  0 ,  6 ) = 20*sqrt(14.0_dp)/429 * ( 1.0 )
     gaunt1(  2 ,  1 ,  6 ) = -sqrt(2625.0_dp)/429 * ( 1.0 )
     gaunt1(  2 ,  2 ,  6 ) = sqrt(100.0_dp)/143 * ( 1.0 )
     gaunt1(  2 ,  3 ,  6 ) = -sqrt(175.0_dp)/429 * ( 1.0 )
