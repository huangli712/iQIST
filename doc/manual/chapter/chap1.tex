...
\end{tikzpicture}
\caption{Schematic picture for the $i$QIST's components. Components on the LHS are CT-HYB solvers, {\jasmine} is the atomic eigenvalue solver, {\daisy} is a HF-QMC solver, and {\hibiscus} contains other pre-processing and post-processing tools. \label{fig:componentlayer}}
\end{figure}
